...
<head>
    ...
    <!-- <link rel="icon"
        href="https://w7.pngwing.com/pngs/786/126/png-transparent-logo-contracting-photography-logo-symbol.png"
        type="image/x-icon"> -->
    ...
    <style>
    /* Media Query cho các màn hình nhỏ hơn 768px (giao diện điện thoại) */
    @media (max-width: 768px) {

        /* Loại bỏ margin cho các phần tử tiêu đề và nội dung */
        .nd,
        .tieude {
            margin: 0 !important;
            padding: 0 !important;
        ...
        /* Điều chỉnh lại kích thước và căn lề ảnh nếu cần */
        .imge {
            width: 100% !important;
            text-align: center !important;
        }

        /* Nếu cần thiết, bạn có thể thêm các thay đổi cho iframe video */
        ...
        if (file_exists($filePath)) {
            ...
            foreach ($lines as $line) {
                echo "@font-face { font-family: '$line';
    src: url('./assets/UTM-font/utm fONT/$line.ttf') format('truetype');
}";
            }
        }
        ?>
    ...
    <div class="container1">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            if ($row['pl'] == $gettask) {
                ...
                ?>
        <div class="container-content" style="display: <?php echo $hide; ?>">
