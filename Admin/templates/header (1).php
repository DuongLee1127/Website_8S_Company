...
<head>
   ...
   <style>/* Màu vàng cho mục đang kéo */
.ui-sortable-helper {
    background-color:rgb(238, 238, 238) !important; /* Màu vàng khi kéo */
}

/* Màu xanh cho vùng thả (vị trí mục được thả vào) */
.ui-sortable-placeholder {
    background-color:rgb(248, 13, 13) !important; 
    border: 2px dashed #ffb6b6; /* Thêm viền để làm nổi bật */
}</style>
</head>